...
def get_nb_frames_for_video(video_parts):
    ...
    # glob.glob returns all the pathnames that have a specified pattern. 
...
def get_video_parts(video_path):
    ...
    filename = parts[2] # the name of the file (complete)
    filename_no_ext = filename.split('.')[0] # The name of the file without the extension
    classname = parts[1] # Whether it belongs to regular or fall
    train_or_test = parts[0] # train or test set
